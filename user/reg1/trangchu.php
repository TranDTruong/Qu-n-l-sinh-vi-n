                ...
                <ul class="nav navbar-nav navbar-left">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="grades.php">Danh sach điểm của Sinh Viên</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Giảng Viên
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="list-teacher.php">Danh sách giảng viên</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Môn học
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="list-subject.php">Danh sách môn học</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">Khoa - Đơn vị
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="list-class-cntt.php">Công nghệ thông tin</a></li>
                            <li><a href="list-class-qtkd.php">Quản trị kinh doanh</a></li>
                        </ul>
                    </li>
        ...
        <div class="row">
            <div class="col-sm-8">
                ...
                <h4>Trường Đại học Thương mại chúng tôi tự hào là trường đại học 5 sao
                    ...
                    <a href="#contact"><br><button class="btn btn-default btn-lg col-lg-3">Liên hệ</button></a>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-7 slideanim">
                ...
                <div class="row">
                    <div class="col-sm-12 form-group">
                        <button class="btn btn-default pull-right" name="btncontact" type="submit">Gửi</button>
                    </div>
                </div>
            </div>
        </div>
